...
- **Brand:** a generated Billabong wordmark was built, shipped, and then **reverted at Wesley's request** — the logo stays icon+text until an artist makes the real one.
...
- [ ] **Replace the interim lucide Instagram glyph + text logo** with an artist-made Wesleygram wordmark. — `enhancement` `S` (`web/src/components/Header.tsx`, `web/src/components/ProfileHeader.tsx`) _(a generated Billabong wordmark was built on fable/web-overhaul and reverted at Wesley's request — waiting on a real artist's mark; the icon+text treatment stays for now)_
