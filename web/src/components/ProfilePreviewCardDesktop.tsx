...
export function ProfilePreviewCardDesktop({ profile, priority = false, size = 180 }: ProfilePreviewCardDesktopProps) {
  ...
  return (
    <Link
      ...
      style={{ width: `${size}px` }}
    >
      <div className={`relative overflow-hidden rounded-xl bg-neutral-200 dark:bg-neutral-800 shadow-md group-hover:shadow-xl transition-shadow duration-300 ${isWesley ? 'creator-glow' : ''}`} style={{ height: `${size}px`, width: `${size}px` }}>
        <Image
          src={imageUrl}
